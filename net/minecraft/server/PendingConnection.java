    ...
    public void a(Packet254GetInfo packet254getinfo) {
        try {
            ...
            if (packet254getinfo.a == 1) {
                List list = Arrays.asList(new Serializable[] { Integer.valueOf(1), Integer.valueOf(72), this.server.getVersion(), this.server.getMotd(), Integer.valueOf(playerlist.getPlayerCount()), Integer.valueOf(playerlist.getMaxPlayers())});
