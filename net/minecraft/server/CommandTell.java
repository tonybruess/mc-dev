    ...
    public void b(ICommandListener icommandlistener, String[] astring) {
        if (astring.length < 2) {
            ...
            if (entityplayer == null) {
                ...
                entityplayer.ICommandListener(ChatMessageComponent.b("commands.message.display.incoming", new Object[] { icommandlistener.getName(), s}).a(EnumChatFormat.GRAY).b(Boolean.valueOf(true)));
                icommandlistener.ICommandListener(ChatMessageComponent.b("commands.message.display.outgoing", new Object[] { entityplayer.getName(), s}).a(EnumChatFormat.GRAY).b(Boolean.valueOf(true)));
            }
        }
    }
