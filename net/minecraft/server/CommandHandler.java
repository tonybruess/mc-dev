    ...
    public int a(ICommandListener icommandlistener, String s) {
        ...
        try {
            ...
            if (icommand.a(icommandlistener)) {
                if (i > -1) {
                    ...
                    for (int l = 0; l < k; ++l) {
                        ...
                        try {
                            ...
                            icommandlistener.ICommandListener(ChatMessageComponent.b(commandexception.getMessage(), commandexception.a()).a(EnumChatFormat.RED));
                        }
                    }
                ...
                icommandlistener.ICommandListener(ChatMessageComponent.e("commands.generic.permission").a(EnumChatFormat.RED));
            }
        } catch (ExceptionUsage exceptionusage) {
            icommandlistener.ICommandListener(ChatMessageComponent.b("commands.generic.usage", new Object[] { ChatMessageComponent.b(exceptionusage.getMessage(), exceptionusage.a())}).a(EnumChatFormat.RED));
        } catch (CommandException commandexception1) {
            icommandlistener.ICommandListener(ChatMessageComponent.b(commandexception1.getMessage(), commandexception1.a()).a(EnumChatFormat.RED));
        } catch (Throwable throwable) {
            icommandlistener.ICommandListener(ChatMessageComponent.e("commands.generic.exception").a(EnumChatFormat.RED));
