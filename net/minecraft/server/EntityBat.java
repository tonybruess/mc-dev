...
public class EntityBat extends EntityAmbient {
    ...
    private ChunkCoordinates lookController;
    ...
    protected void be() {
        ...
        if (this.bF()) {
            ...
            if (this.lookController != null && (!this.world.isEmpty(this.lookController.x, this.lookController.y, this.lookController.z) || this.lookController.y < 1)) {
                this.lookController = null;
            }

            if (this.lookController == null || this.random.nextInt(30) == 0 || this.lookController.e((int) this.locX, (int) this.locY, (int) this.locZ) < 4.0F) {
                this.lookController = new ChunkCoordinates((int) this.locX + this.random.nextInt(7) - this.random.nextInt(7), (int) this.locY + this.random.nextInt(6) - 2, (int) this.locZ + this.random.nextInt(7) - this.random.nextInt(7));
            }

            double d0 = (double) this.lookController.x + 0.5D - this.locX;
            double d1 = (double) this.lookController.y + 0.1D - this.locY;
            double d2 = (double) this.lookController.z + 0.5D - this.locZ;
