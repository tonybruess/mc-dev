...
public class EntityPlayer extends EntityHuman implements ICrafting {
    ...
    public void h() {
        try {
            ...
            if (this.aJ() != this.bP || this.bQ != this.foodData.a() || this.foodData.e() == 0.0F != this.bR) {
                this.playerConnection.sendPacket(new Packet8UpdateHealth(this.aJ(), this.foodData.a(), this.foodData.e()));
                this.bP = this.aJ();
    ...
    public void die(DamageSource damagesource) {
        this.server.getPlayerList().a(this.aN().b());
    ...
    public void a(EntityHorse entityhorse, IInventory iinventory) {
        ...
        this.activeContainer = new ContainerHorseInventory(this.inventory, iinventory, entityhorse);
        this.activeContainer.windowId = this.containerCounter;
        this.activeContainer.addSlotListener(this);
    }
    ...
    public void a(String s) {
        this.playerConnection.sendPacket(new Packet3Chat(ChatMessageComponent.e(s)));
    }
    ...
    public void ICommandListener(ChatMessageComponent chatmessagecomponent) {
        this.playerConnection.sendPacket(new Packet3Chat(chatmessagecomponent));
    }
