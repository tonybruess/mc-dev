...
public class WorldGenPyramidPiece extends WorldGenScatteredPiece {
    ...
    private static final StructurePieceTreasure[] i = new StructurePieceTreasure[] { new StructurePieceTreasure(Item.DIAMOND.id, 0, 1, 3, 3), new StructurePieceTreasure(Item.IRON_INGOT.id, 0, 1, 5, 10), new StructurePieceTreasure(Item.GOLD_INGOT.id, 0, 2, 7, 15), new StructurePieceTreasure(Item.EMERALD.id, 0, 1, 3, 2), new StructurePieceTreasure(Item.BONE.id, 0, 4, 6, 20), new StructurePieceTreasure(Item.ROTTEN_FLESH.id, 0, 3, 7, 16), new StructurePieceTreasure(Item.SADDLE.id, 0, 1, 1, 3), new StructurePieceTreasure(Item.ce.id, 0, 1, 1, 1), new StructurePieceTreasure(Item.cf.id, 0, 1, 1, 1), new StructurePieceTreasure(Item.cg.id, 0, 1, 1, 1)};
