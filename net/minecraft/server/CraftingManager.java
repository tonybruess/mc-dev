...
public class CraftingManager {
    ...
    private CraftingManager() {
        ...
        this.registerShapedRecipe(new ItemStack(Item.ch, 2), new Object[] { "~~ ", "~O ", "  ~", Character.valueOf('~'), Item.STRING, Character.valueOf('O'), Item.SLIME_BALL});
        this.registerShapedRecipe(new ItemStack(Block.HAY, 1), new Object[] { "###", "###", "###", Character.valueOf('#'), Item.WHEAT});
