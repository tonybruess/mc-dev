...
public class CombatTracker {
    ...
    public ChatMessageComponent b() {
        if (this.a.size() == 0) {
            return ChatMessageComponent.b("death.attack.generic", new Object[] { this.b.getScoreboardDisplayName()});
        } else {
                ...
                if (combatentry.a() != DamageSource.FALL && combatentry.a() != DamageSource.OUT_OF_WORLD) {
                    if (s1 != null && (s == null || !s1.equals(s))) {
                        ...
                        if (itemstack != null && itemstack.hasName()) {
                            chatmessagecomponent = ChatMessageComponent.b("death.fell.assist.item", new Object[] { this.b.getScoreboardDisplayName(), s1, itemstack.getName()});
                        } else {
                            chatmessagecomponent = ChatMessageComponent.b("death.fell.assist", new Object[] { this.b.getScoreboardDisplayName(), s1});
                        }
                    } else if (s != null) {
                        ItemStack itemstack1 = entity instanceof EntityLiving ? ((EntityLiving) entity).aV() : null;

                        if (itemstack1 != null && itemstack1.hasName()) {
                            chatmessagecomponent = ChatMessageComponent.b("death.fell.finish.item", new Object[] { this.b.getScoreboardDisplayName(), s, itemstack1.getName()});
                        } else {
                            chatmessagecomponent = ChatMessageComponent.b("death.fell.finish", new Object[] { this.b.getScoreboardDisplayName(), s});
                        }
                    } else {
                        chatmessagecomponent = ChatMessageComponent.b("death.fell.killer", new Object[] { this.b.getScoreboardDisplayName()});
                    }
                } else {
                    chatmessagecomponent = ChatMessageComponent.b("death.fell.accident." + this.a(combatentry), new Object[] { this.b.getScoreboardDisplayName()});
                }
            } else {
                chatmessagecomponent = combatentry1.a().b(this.b);
            }
