...
public class EntityPigZombie extends EntityZombie {
    ...
    private static final AttributeModifier equipment = (new AttributeModifier(bq, "Attacking speed boost", 0.45D, 0)).a(false);
    ...
    protected void ax() {
        super.ax();
        this.a(goalTarget).a(0.0D);
        this.a(ItemHayStack.d).a(0.5D);
        this.a(ItemHayStack.e).a(5.0D);
    }
