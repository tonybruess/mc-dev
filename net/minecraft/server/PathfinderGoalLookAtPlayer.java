...
public class PathfinderGoalLookAtPlayer extends PathfinderGoal {
    ...
    public PathfinderGoalLookAtPlayer(EntityLivingBase entitylivingbase, Class oclass, float f) {
    ...
    public PathfinderGoalLookAtPlayer(EntityLivingBase entitylivingbase, Class oclass, float f, float f1) {
        this.b = entitylivingbase;
        this.f = oclass;
        this.c = f;
        this.e = f1;
