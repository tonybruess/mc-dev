...
public class EntityDamageSourceIndirect extends EntityDamageSource {
    ...
    public ChatMessageComponent b(EntityLiving entityliving) {
        ...
        return itemstack != null && itemstack.hasName() && LocaleI18n.b(s2) ? ChatMessageComponent.b(s2, new Object[] { entityliving.getScoreboardDisplayName(), s, itemstack.getName()}) : ChatMessageComponent.b(s1, new Object[] { entityliving.getScoreboardDisplayName(), s});
    }
}
