...
public class ContainerPlayer extends Container {
    ...
    public ItemStack b(EntityHuman entityhuman, int i) {
        ...
        if (slot != null && slot.e()) {
            ...
            } else if (itemstack.getItem() instanceof ItemArmor && !((Slot) this.c.get(5 + ((ItemArmor) itemstack.getItem()).durability)).e()) {
                int j = 5 + ((ItemArmor) itemstack.getItem()).durability;
