...
public class EntityHorse extends EntityAnimal implements IInventoryListener {
    ...
    private static final Attribute bv = (new AttributeRanged("horse.jumpStrength", 0.7D, 0.0D, 2.0D)).a("Jump Strength").a(true);
    ...
    private ContainerAnimal bG;
    private boolean bH;
    protected int canPickUpLoot;
    protected float persistent;
    private boolean bI;
    private float bJ;
    private float bK;
    private float bL;
    ...
    public EntityHorse(World world) {
        ...
        this.goalSelector.a(1, new PathfinderGoalRunAround(this, 1.2D));
    ...
    public int d(ItemStack itemstack) {
        return itemstack == null ? 0 : (itemstack.id == Item.ce.id ? 1 : (itemstack.id == Item.cf.id ? 2 : (itemstack.id == Item.cg.id ? 3 : 0)));
    }
    ...
    private void cD() {
        ContainerAnimal containeranimal = this.bG;

        this.bG = new ContainerAnimal("HorseChest", this.cC());
        this.bG.a(this.getLocalizedName());
        if (containeranimal != null) {
            containeranimal.b(this);
            int i = Math.min(containeranimal.getSize(), this.bG.getSize());

            for (int j = 0; j < i; ++j) {
                ItemStack itemstack = containeranimal.getItem(j);
    ...
    protected void ax() {
        super.ax();
        this.aT().b(bv);
        this.a(ItemHayStack.a).a(53.0D);
        this.a(ItemHayStack.d).a(0.22499999403953552D);
    }
        ...
        if (itemstack != null && itemstack.id == Item.MONSTER_EGG.id) {
            ...
            if (itemstack != null) {
                ...
                if (this.cr()) {
                    ...
                    if (itemstack.id == Item.ce.id) {
                        b0 = 1;
                    } else if (itemstack.id == Item.cf.id) {
                        b0 = 2;
                    } else if (itemstack.id == Item.cg.id) {
                        b0 = 3;
                    }
                ...
                if (!flag && !this.cu()) {
                    ...
                    if (itemstack.id == Item.WHEAT.id) {
                        ...
                        short1 = 180;
                        b1 = 3;
                    } else if (itemstack.id == Block.HAY.id) {
                        f = 20.0F;
                        short1 = 180;
    ...
    public void c() {
        ...
        super.c();
        if (!this.world.isStatic) {
            if (this.random.nextInt(900) == 0 && this.aB == 0) {
                this.f(1.0F);
            }
    ...
    private boolean cJ() {
        return this.passenger == null && this.vehicle == null && this.bS() && this.bR() && !this.cv() && this.aJ() >= this.aP();
    }

    public void die() {
        if (this.world.isStatic || !this.bS() && !this.ce() || this.aJ() <= 0.0F) {
            super.die();
        }
    }
    ...
    private void a(Entity entity, ContainerAnimal containeranimal) {
        if (containeranimal != null && !this.world.isStatic) {
            for (int i = 0; i < containeranimal.getSize(); ++i) {
                ItemStack itemstack = containeranimal.getItem(i);
    ...
    public void e(float f, float f1) {
        if (this.passenger != null && this.ck()) {
            ...
            if (this.onGround && this.persistent == 0.0F && this.cd() && !this.bI) {
                f = 0.0F;
                f1 = 0.0F;
            }

            if (this.persistent > 0.0F && !this.bZ() && this.onGround) {
                this.motY = this.cj() * (double) this.persistent;
                ...
                if (f1 > 0.0F) {
                    ...
                    this.motX += (double) (-0.4F * f2 * this.persistent);
                    this.motZ += (double) (0.4F * f3 * this.persistent);
            ...
            if (!this.world.isStatic) {
                this.i((float) this.a(ItemHayStack.d).e());
                super.e(f, f1);
            }
    ...
    public void a(NBTTagCompound nbttagcompound) {
        ...
        if (attributeinstance != null) {
            this.a(ItemHayStack.d).a(attributeinstance.b() * 0.25D);
        }
    ...
    public EntityAgeable createChild(EntityAgeable entityageable) {
        ...
        entityhorse1.p(k);
        double d0 = this.a(ItemHayStack.a).b() + entityageable.a(ItemHayStack.a).b() + (double) this.cL();

        entityhorse1.a(ItemHayStack.a).a(d0 / 3.0D);
        double d1 = this.a(bv).b() + entityageable.a(bv).b() + this.cM();

        entityhorse1.a(bv).a(d1 / 3.0D);
        double d2 = this.a(ItemHayStack.d).b() + entityageable.a(ItemHayStack.d).b() + this.cN();

        entityhorse1.a(ItemHayStack.d).a(d2 / 3.0D);
        return entityhorse1;
    }
    ...
    public EntityLivingData a(EntityLivingData entitylivingdata) {
        ...
        if (object instanceof EntityLivingDataBase) {
            j = ((EntityLivingDataBase) object).a;
            i = ((EntityLivingDataBase) object).b & 255 | this.random.nextInt(5) << 8;
        } else {
            ...
            object = new EntityLivingDataBase(j, i);
        }
        ...
        if (j != 4 && j != 3) {
            this.a(ItemHayStack.a).a((double) this.cL());
            if (j == 0) {
                this.a(ItemHayStack.d).a(this.cN());
            } else {
                this.a(ItemHayStack.d).a(0.17499999701976776D);
            }
        } else {
            this.a(ItemHayStack.a).a(15.0D);
    ...
    public void u(int i) {
        ...
        if (i >= 90) {
            this.persistent = 1.0F;
        } else {
            this.persistent = 0.4F + 0.4F * (float) i / 90.0F;
        }
    }
    ...
    public static boolean v(int i) {
        return i == Item.ce.id || i == Item.cf.id || i == Item.cg.id;
    }
