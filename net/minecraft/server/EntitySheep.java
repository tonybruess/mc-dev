...
public class EntitySheep extends EntityAnimal {
    ...
    public static final float[][] love = new float[][] { { 1.0F, 1.0F, 1.0F}, { 0.85F, 0.5F, 0.2F}, { 0.7F, 0.3F, 0.85F}, { 0.4F, 0.6F, 0.85F}, { 0.9F, 0.9F, 0.2F}, { 0.5F, 0.8F, 0.1F}, { 0.95F, 0.5F, 0.65F}, { 0.3F, 0.3F, 0.3F}, { 0.6F, 0.6F, 0.6F}, { 0.3F, 0.5F, 0.6F}, { 0.5F, 0.25F, 0.7F}, { 0.2F, 0.3F, 0.7F}, { 0.4F, 0.3F, 0.2F}, { 0.4F, 0.5F, 0.2F}, { 0.6F, 0.2F, 0.2F}, { 0.1F, 0.1F, 0.1F}};
    private int equipment;
    private PathfinderGoalEatTile canPickUpLoot = new PathfinderGoalEatTile(this);
    ...
    public EntitySheep(World world) {
        ...
        this.goalSelector.a(5, this.canPickUpLoot);
    ...
    protected void be() {
        this.equipment = this.canPickUpLoot.f();
        super.be();
    }

    public void c() {
        if (this.world.isStatic) {
            this.equipment = Math.max(0, this.equipment - 1);
        }
