...
public abstract class EntityLivingBase extends EntityLiving {
    ...
    protected void ax() {
        super.ax();
        this.aT().b(ItemHayStack.b).a(16.0D);
    }
    ...
    public void b(NBTTagCompound nbttagcompound) {
        ...
        if (this.bw != null) {
            ...
            if (this.bw instanceof EntityLiving) {
                nbttagcompound1.setLong("UUIDMost", this.bw.au().getMostSignificantBits());
                nbttagcompound1.setLong("UUIDLeast", this.bw.au().getLeastSignificantBits());
                    ...
                    if (i > -1) {
                        ...
                        if (itemstack1 != null) {
                            if (i == 0) {
                                ...
                                if (itemarmor.craftingResult == itemarmor1.craftingResult) {
                                    flag = itemstack.getData() > itemstack1.getData() || itemstack.hasTag() && !itemstack1.hasTag();
                                } else {
                                    flag = itemarmor.craftingResult > itemarmor1.craftingResult;
                                }
                            } else {
                                flag = false;
                            }
    ...
    protected void bk() {
        if (this.persistent) {
            ...
            if (entityhuman != null) {
                ...
                if (this.aV > 600 && this.random.nextInt(800) == 0 && d3 > 1024.0D && this.isTypeNotPersistent()) {
                    this.die();
                } else if (d3 < 1024.0D) {
                    this.aV = 0;
                }
    ...
    public static int b(ItemStack itemstack) {
        if (itemstack.id != Block.PUMPKIN.id && itemstack.id != Item.SKULL.id) {
            if (itemstack.getItem() instanceof ItemArmor) {
                switch (((ItemArmor) itemstack.getItem()).durability) {
                case 0:
                    return 4;
    ...
    public EntityLivingData a(EntityLivingData entitylivingdata) {
        this.a(ItemHayStack.b).a(new AttributeModifier("Random spawn bonus", this.random.nextGaussian() * 0.05D, 1));
    ...
    public final boolean c(EntityHuman entityhuman) {
        if (this.bD() && this.bE() == entityhuman) {
            ...
            if (itemstack != null && itemstack.id == Item.ch.id && this.bC()) {
        ...
        if (this.bv && this.bx != null) {
            if (this.bx.hasKey("UUIDMost") && this.bx.hasKey("UUIDLeast")) {
                ...
                while (iterator.hasNext()) {
                    ...
                    if (entityliving.au().equals(uuid)) {
                ...
                EntityLeashKnot entityleashknot = EntityLeashKnot.b(this.world, i, j, k);

                if (entityleashknot == null) {
                    entityleashknot = EntityLeashKnot.a(this.world, i, j, k);
                }
