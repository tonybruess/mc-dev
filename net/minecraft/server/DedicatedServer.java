...
public class DedicatedServer extends MinecraftServer implements IMinecraftServer {
    ...
    private final IConsoleLogManager convertable;
    private RemoteStatusListener n;
    private RemoteControlListener universe;
    private PropertyManager propertyManager;
    private boolean generateStructures;
    private EnumGamemode serverIp;
    private ServerConnection s;
    private boolean t;

    public DedicatedServer(File file1) {
        super(file1);
        this.convertable = new ConsoleLogManager("Minecraft-Server", (String) null, (new File(file1, "server.log")).getAbsolutePath());
    ...
    protected boolean init() {
        ...
        this.getLogger().info("Starting minecraft server version 1.6");
        ...
        this.serverIp = WorldSettings.a(i);
        this.getLogger().info("Default game type: " + this.serverIp);
        ...
        if (this.propertyManager.getBoolean("enable-rcon", false)) {
            ...
            this.universe = new RemoteControlListener(this);
            this.universe.a();
        }
