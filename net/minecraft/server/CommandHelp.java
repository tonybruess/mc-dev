...
public class CommandHelp extends CommandAbstract {
    ...
    public void b(ICommandListener icommandlistener, String[] astring) {
        ...
        icommandlistener.ICommandListener(ChatMessageComponent.b("commands.help.header", new Object[] { Integer.valueOf(j + 1), Integer.valueOf(i + 1)}).a(EnumChatFormat.DARK_GREEN));

        for (int l = j * b0; l < k; ++l) {
            icommand = (ICommand) list.get(l);
            icommandlistener.ICommandListener(ChatMessageComponent.e(icommand.c(icommandlistener)));
        }

        if (j == 0 && icommandlistener instanceof EntityHuman) {
            icommandlistener.ICommandListener(ChatMessageComponent.e("commands.help.footer").a(EnumChatFormat.GREEN));
        }
    }
