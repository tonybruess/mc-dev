...
public class ItemDye extends Item {
    ...
    public static final String[] durability = new String[] { "black", "red", "green", "brown", "blue", "purple", "cyan", "silver", "gray", "pink", "lime", "yellow", "light_blue", "magenta", "orange", "white"};
    public static final int[] craftingResult = new int[] { 1973019, 11743532, 3887386, 5320730, 2437522, 8073150, 2651799, 11250603, 4408131, 14188952, 4312372, 14602026, 6719955, 12801229, 15435844, 15790320};
        ...
        if (l == Block.SAPLING.id) {
            ...
            if (!world.isStatic) {
                if ((double) world.random.nextFloat() < 0.4D) {
                    ((BlockMushroom) Block.byId[l]).grow(world, i, j, k, world.random);
                }
