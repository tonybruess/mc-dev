...
public class MobEffectList {
    ...
    public static final MobEffectList FASTER_MOVEMENT = (new MobEffectList(1, false, 8171462)).b("potion.moveSpeed").b(0, 0).a(ItemHayStack.d, "91AEAA56-376B-4498-935B-2F7F68070635", 0.20000000298023224D, 2);
    public static final MobEffectList SLOWER_MOVEMENT = (new MobEffectList(2, true, 5926017)).b("potion.moveSlowdown").b(1, 0).a(ItemHayStack.d, "7107DE5E-7CE8-4030-940E-514C1F160890", -0.15000000596046448D, 2);
    ...
    public static final MobEffectList INCREASE_DAMAGE = (new AttackDamageMobEffect(5, false, 9643043)).b("potion.damageBoost").b(4, 0).a(ItemHayStack.e, "648D7064-6A60-4F59-8ABE-C2C23A6DD7A9", 3.0D, 2);
    ...
    public static final MobEffectList WEAKNESS = (new AttackDamageMobEffect(18, true, 4738376)).b("potion.weakness").b(5, 0).a(ItemHayStack.e, "22653B89-116E-49DC-9B6B-9971489B5BE5", 2.0D, 0);
    ...
    public static final MobEffectList w = (new HealthBoostMobEffect(21, false, 16284963)).b("potion.healthBoost").b(2, 2).a(ItemHayStack.a, "5D6F0BA2-1186-46AC-B896-C61C5CEE99CC", 4.0D, 0);
    public static final MobEffectList x = (new AbsoptionMobEffect(22, false, 2445989)).b("potion.absorption").b(2, 2);
    ...
    public void a(EntityLiving entityliving, int i) {
        if (this.id == REGENERATION.id) {
            ...
            entityliving.f((float) Math.max(4 << i, 0));
        }
    }
    ...
    public MobEffectList a(Attribute attribute, String s, double d0, int i) {
    ...
    public void a(EntityLiving entityliving, AttributeMapBase attributemapbase, int i) {
        ...
        while (iterator.hasNext()) {
            ...
            AttributeInstance attributeinstance = attributemapbase.a((Attribute) entry.getKey());
