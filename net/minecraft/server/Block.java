...
public class Block {
    ...
    public static final Block WOOL = (new BlockColored(35, Material.CLOTH)).c(0.8F).a(n).c("cloth").d("wool_colored");
    ...
    public static final Block CLAY_STAINED = (new BlockColored(159, Material.STONE)).c(1.25F).b(7.0F).a(k).c("clayHardenedStained").d("hardened_clay_stained");
    public static final Block HAY = (new BlockHay(170)).c(0.5F).a(j).c("hayBlock").a(CreativeModeTab.b).d("hay_block");
    public static final Block CARPET = (new BlockCarpet(171)).c(0.1F).a(n).c("woolCarpet").k(0);
    public static final Block CLAY_HARDENED = (new Block(172, Material.STONE)).c(1.25F).b(7.0F).a(k).c("clayHardened").a(CreativeModeTab.b).d("hardened_clay");
    ...
    public void a(World world, EntityHuman entityhuman, int i, int j, int k, int l) {
        ...
        if (this.r_() && EnchantmentManager.e(entityhuman)) {
            ...
            int i1 = EnchantmentManager.f(entityhuman);
    ...
    static {
        ...
        Item.byId[CLAY_STAINED.id] = (new ItemCloth(CLAY_STAINED.id - 256)).b("clayHardenedStained");
        Item.byId[CARPET.id] = (new ItemCloth(CARPET.id - 256)).b("woolCarpet");
