...
public class EntityEnderman extends EntityMonster {
    ...
    private static final UUID goalTarget = UUID.fromString("020E0DFB-87AE-4653-9556-831010E291A0");
    private static final AttributeModifier bq = (new AttributeModifier(goalTarget, "Attacking speed boost", 6.199999809265137D, 0)).a(false);
    private static boolean[] equipment = new boolean[256];
    ...
    protected void ax() {
        super.ax();
        this.a(ItemHayStack.a).a(40.0D);
        this.a(ItemHayStack.d).a(0.30000001192092896D);
        this.a(ItemHayStack.e).a(7.0D);
    }
    ...
    public void c() {
        ...
        if (!this.world.isStatic && this.isAlive()) {
            if (this.target != null) {
                ...
                } else if (this.target.e((Entity) this) > 256.0D && this.canPickUpLoot++ >= 30 && this.c(this.target)) {
                    this.canPickUpLoot = 0;
                }
            } else {
                this.a(false);
    ...
    static {
        equipment[Block.GRASS.id] = true;
        equipment[Block.DIRT.id] = true;
        equipment[Block.SAND.id] = true;
        equipment[Block.GRAVEL.id] = true;
        equipment[Block.YELLOW_FLOWER.id] = true;
        equipment[Block.RED_ROSE.id] = true;
        equipment[Block.BROWN_MUSHROOM.id] = true;
        equipment[Block.RED_MUSHROOM.id] = true;
        equipment[Block.TNT.id] = true;
        equipment[Block.CACTUS.id] = true;
        equipment[Block.CLAY.id] = true;
        equipment[Block.PUMPKIN.id] = true;
        equipment[Block.MELON.id] = true;
        equipment[Block.MYCEL.id] = true;
    }
}
