...
public class Item {
    ...
    public static Item ce = (new Item(161)).b("horsearmormetal").d(1).a(CreativeModeTab.f).d("iron_horse_armor");
    public static Item cf = (new Item(162)).b("horsearmorgold").d(1).a(CreativeModeTab.f).d("gold_horse_armor");
    public static Item cg = (new Item(163)).b("horsearmordiamond").d(1).a(CreativeModeTab.f).d("diamond_horse_armor");
    public static Item ch = (new ItemHay(164)).b("leash").d("lead");
