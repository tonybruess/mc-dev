...
public class EntityWolf extends EntityTameableAnimal {
    ...
    public EntityWolf(World world) {
        ...
        this.goalSelector.a(2, this.love);
    ...
    protected void bg() {
        this.datawatcher.watch(18, Float.valueOf(this.aJ()));
    }

    protected void a() {
        super.a();
        this.datawatcher.a(18, new Float(this.aJ()));
        this.datawatcher.a(19, new Byte((byte) 0));
        this.datawatcher.a(20, new Byte((byte) BlockColored.j_(1)));
    }
    ...
    protected String r() {
        return this.isAngry() ? "mob.wolf.growl" : (this.random.nextInt(3) == 0 ? (this.isTamed() && this.datawatcher.d(18) < 10.0F ? "mob.wolf.whine" : "mob.wolf.panting") : "mob.wolf.bark");
    }
    ...
    public void c() {
        super.c();
        if (!this.world.isStatic && this.canPickUpLoot && !this.persistent && !this.bI() && this.onGround) {
    ...
    public void l_() {
        ...
        if (this.F()) {
            ...
            this.bu = 0.0F;
            this.bv = 0.0F;
        } else if ((this.canPickUpLoot || this.persistent) && this.persistent) {
            if (this.bu == 0.0F) {
    ...
    public boolean m(Entity entity) {
        ...
        return entity.damageEntity(DamageSource.a((EntityLiving) this), (float) i);
    }
        ...
        if (this.isTamed()) {
            if (itemstack != null) {
                if (Item.byId[itemstack.id] instanceof ItemFood) {
                    ...
                    if (itemfood.j() && this.datawatcher.d(18) < 20.0F) {
                        if (!entityhuman.abilities.canInstantlyBuild) {
                            --itemstack.count;
                        }

                        this.f((float) itemfood.getNutrition());
                    ...
                    int i = BlockColored.j_(itemstack.getData());
            ...
            if (entityhuman.getName().equalsIgnoreCase(this.getOwnerName()) && !this.world.isStatic && !this.c(itemstack)) {
                this.love.setSitting(!this.isSitting());
                this.bd = false;
