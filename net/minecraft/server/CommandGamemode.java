...
public class CommandGamemode extends CommandAbstract {
    ...
    public void b(ICommandListener icommandlistener, String[] astring) {
        if (astring.length > 0) {
            ...
            ChatMessageComponent chatmessagecomponent = ChatMessageComponent.e("gameMode." + enumgamemode.b());

            if (entityplayer != icommandlistener) {
                a(icommandlistener, 1, "commands.gamemode.success.other", new Object[] { entityplayer.getLocalizedName(), chatmessagecomponent});
            } else {
                a(icommandlistener, 1, "commands.gamemode.success.self", new Object[] { chatmessagecomponent});
            }
        } else {
