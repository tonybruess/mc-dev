...
public class EntitySpider extends EntityMonster {
    ...
    protected void ax() {
        super.ax();
        this.a(ItemHayStack.a).a(16.0D);
        this.a(ItemHayStack.d).a(0.800000011920929D);
    }
    ...
    public EntityLivingData a(EntityLivingData entitylivingdata) {
        ...
        if (object == null) {
            object = new EntityLead();
            if (this.world.difficulty > 2 && this.world.random.nextFloat() < 0.1F * this.world.b(this.locX, this.locY, this.locZ)) {
                ((EntityLead) object).a(this.world.random);
            }
        }

        if (object instanceof EntityLead) {
            int i = ((EntityLead) object).a;

            if (i > 0 && MobEffectList.byId[i] != null) {
                this.d(new MobEffect(i, Integer.MAX_VALUE));
            }
        }
