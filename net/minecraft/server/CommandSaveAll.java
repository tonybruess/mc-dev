...
public class CommandSaveAll extends CommandAbstract {
    ...
    public void b(ICommandListener icommandlistener, String[] astring) {
        ...
        icommandlistener.ICommandListener(ChatMessageComponent.e("commands.save.start"));
        ...
        try {
            ...
            if (astring.length > 0 && "flush".equals(astring[0])) {
                icommandlistener.ICommandListener(ChatMessageComponent.e("commands.save.flushStart"));
                ...
                icommandlistener.ICommandListener(ChatMessageComponent.e("commands.save.flushEnd"));
            }
