...
public class PlayerChunkMap {
    ...
    public void addPlayer(EntityPlayer entityplayer) {
        ...
        entityplayer.fireTicks = entityplayer.locX;
        entityplayer.justCreated = entityplayer.locZ;
    ...
    public void removePlayer(EntityPlayer entityplayer) {
        int i = (int) entityplayer.fireTicks >> 4;
        int j = (int) entityplayer.justCreated >> 4;
    ...
    public void movePlayer(EntityPlayer entityplayer) {
        int i = (int) entityplayer.locX >> 4;
        int j = (int) entityplayer.locZ >> 4;
        double d0 = entityplayer.fireTicks - entityplayer.locX;
        double d1 = entityplayer.justCreated - entityplayer.locZ;
        double d2 = d0 * d0 + d1 * d1;

        if (d2 >= 64.0D) {
            int k = (int) entityplayer.fireTicks >> 4;
            int l = (int) entityplayer.justCreated >> 4;
            int i1 = this.f;
            int j1 = i - k;
            int k1 = j - l;
