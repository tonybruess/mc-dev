...
public abstract class EntityHuman extends EntityLiving implements ICommandListener {
    ...
    private ChunkCoordinates justCreated;
    ...
    protected void ax() {
        super.ax();
        this.aT().b(ItemHayStack.e).a(1.0D);
    }
    ...
    protected boolean aY() {
        return this.aJ() <= 0.0F || this.isSleeping();
    }
    ...
    public void c() {
        ...
        if (this.world.difficulty == 0 && this.aJ() < this.aP() && this.world.getGameRules().getBoolean("naturalRegeneration") && this.ticksLived % 20 * 12 == 0) {
            this.f(1.0F);
        }
    ...
    public float a(Block block, boolean flag) {
        ...
        if (f > 1.0F) {
            int i = EnchantmentManager.c(this);
            ItemStack itemstack = this.inventory.getItemInHand();
        ...
        if (this.a(MobEffectList.FASTER_DIG)) {
            f *= 1.0F + (float) (this.b(MobEffectList.FASTER_DIG).getAmplifier() + 1) * 0.2F;
        }

        if (this.a(MobEffectList.SLOWER_DIG)) {
            f *= 1.0F - (float) (this.b(MobEffectList.SLOWER_DIG).getAmplifier() + 1) * 0.2F;
        }
    ...
    public void a(NBTTagCompound nbttagcompound) {
        ...
        if (nbttagcompound.hasKey("SpawnX") && nbttagcompound.hasKey("SpawnY") && nbttagcompound.hasKey("SpawnZ")) {
            ...
            this.fireTicks = nbttagcompound.getBoolean("SpawnForced");
        }
    ...
    public void b(NBTTagCompound nbttagcompound) {
        ...
        if (this.c != null) {
            ...
            nbttagcompound.setBoolean("SpawnForced", this.fireTicks);
        }
    ...
    public void attack(Entity entity) {
        if (entity.ao()) {
            if (!entity.i(this)) {
                ...
                if (f > 0.0F || f1 > 0.0F) {
                    boolean flag = this.fallDistance > 0.0F && !this.onGround && !this.e() && !this.G() && !this.a(MobEffectList.BLINDNESS) && this.vehicle == null && entity instanceof EntityLiving;
    ...
    public float bc() {
        return (float) this.a(ItemHayStack.d).e();
    }
            ...
            if (i > 0) {
                if (this.vehicle instanceof EntityMinecartAbstract) {
                    ...
                    if (this.justCreated == null) {
                        this.justCreated = new ChunkCoordinates(MathHelper.floor(this.locX), MathHelper.floor(this.locY), MathHelper.floor(this.locZ));
                    } else if ((double) this.justCreated.e(MathHelper.floor(this.locX), MathHelper.floor(this.locY), MathHelper.floor(this.locZ)) >= 1000000.0D) {
    ...
    public void levelDown(int i) {
        ...
        if (i > 0 && this.expLevel % 5 == 0 && (float) this.invulnerable < (float) this.ticksLived - 100.0F) {
            float f = this.expLevel > 30 ? 1.0F : (float) this.expLevel / 30.0F;

            this.world.makeSound(this, "random.levelup", f * 0.75F, 1.0F);
            this.invulnerable = this.ticksLived;
        }
    }
