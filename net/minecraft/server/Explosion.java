...
public class Explosion {
    ...
    public EntityLiving c() {
        return this.source == null ? null : (this.source instanceof EntityTNTPrimed ? ((EntityTNTPrimed) this.source).c() : (this.source instanceof EntityLiving ? (EntityLiving) this.source : null));
    }
}
